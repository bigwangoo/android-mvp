...
/**
 * 配合{@link IFragmentILifecycle}使用,使{@link Fragment}具有{@link RxLifecycle}的特性
 * <p>
...
public class FragmentLifecycleForRxLifecycle extends FragmentManager.FragmentLifecycleCallbacks {
    ...
    public void onFragmentAttached(FragmentManager fm, Fragment f, Context context) {
        if (f instanceof IFragmentILifecycle) {
    ...
    private Subject<FragmentEvent> obtainSubject(Fragment fragment) {
        return ((IFragmentILifecycle) fragment).provideLifecycleSubject();
    }
}
