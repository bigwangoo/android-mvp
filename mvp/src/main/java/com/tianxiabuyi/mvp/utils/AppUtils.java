...
public class AppUtils {
     ...
     * 设置hint大小
     */
    public static void setViewHintSize(Context context, int size, TextView tv, int res) {
        ...
        // 设置hint
        tv.setHint(new SpannedString(ss)); // 一定要进行转换,否则属性会消失
    }
    ...
    public static void snackbarText(String text) {
        ...
        message.what = AppManager.TYPE_SHOW_SNACK_BAR;
        message.obj = text;
        message.arg1 = 0;
    ...
    public static void startActivity(Class activityClass) {
        Message message = new Message();
        message.what = AppManager.TYPE_START_ACTIVITY;
    ...
    public static void killAll() {
        Message message = new Message();
        message.what = AppManager.TYPE_KILL_ALL;
        ;
        AppManager.post(message);
    }
    ...
    public static void exitApp() {
        Message message = new Message();
        message.what = AppManager.TYPE_APP_EXIT;
        AppManager.post(message);
    }
